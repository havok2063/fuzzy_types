...
releases_issue_uri = "https://github.com/havok2063/fuzzy_types/issues/%s"
releases_release_uri = "https://github.com/havok2063/fuzzy_types/tree/%s"
...
.. |fuzzy_types_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('fuzzy_types')
...
man_pages = [
    (master_doc, 'fuzzy_types', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'havok2063/fuzzy_types'
